        ...
        <body className="about-body">
          ...
          <div className="about-container">
            <div className="about-words">
              <p className="about-p-emphasis">GROWING UP, MY BICYCLE WAS MY FIRST TICKET TO FREEDOM.</p>
              <p className="about-p">
                ...
                a more ultiltarian purpose when I moved to Chicago to attend
                ...
                to Minnesota, I returned to cycling for the pure joy of the
                sport when I discovered mountain biking. Since then I have found
                myself becoming more and more fascinated with all aspects of
                cycling and have competed in gravel racing and criterium racing.
              </p>
              <p className="about-p">
                ...
                Hospitals in major metropolitain areas. In this setting I assess
